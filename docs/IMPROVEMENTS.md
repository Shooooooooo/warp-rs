...
**Done: 5 of the 22 numbered items.** The feature list at the end is a separate
wish list, not a backlog.
...
- [ ] **2. `--stars` and `--size` are unbounded, and the abort wrecks the
